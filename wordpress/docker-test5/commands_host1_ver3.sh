...
docker exec -it $targethost bash -c "wp core install --url=$zurl --title='Just Another Blog' --admin_user=$admin_user --admin_password=$admin_password --admin_email=$admin_email --path=/var/www/html --allow-root --skip-email"
